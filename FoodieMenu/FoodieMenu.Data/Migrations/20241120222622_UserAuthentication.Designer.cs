...
namespace FoodieMenu.Data.Migrations
{
    ...
    [Migration("20241120222622_UserAuthentication")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FoodieMenu.Domain.UserAuthentication.UserAccount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("RestaurantUserAccount", b =>
                {
                    ...
                    b.HasKey("UsersId", "restaurantsRestaurantID");

                    b.HasIndex("restaurantsRestaurantID");

                    b.ToTable("RestaurantUserAccount");
                });
            ...
            modelBuilder.Entity("RestaurantUserAccount", b =>
                {
                    b.HasOne("FoodieMenu.Domain.UserAuthentication.UserAccount", null)
                        .WithMany()
